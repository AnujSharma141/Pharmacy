        ...
        <div className='sales'>
            ...
            <div className='sales-chart'>
                ...
                {sales.status?filter.length!==0? filter.map(item=>{return(
                    <div className='sales-chart-item'><p className='sales-chart-count-no'>{count++}</p><p className='sales-chart-item-name'>{item.name}</p><p className='sales-chart-count'>{item.amount}</p><p className='sales-chart-inc'>1230</p></div>
