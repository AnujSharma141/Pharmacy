...
export default function Dash() {
    ...
    return (
        <div className='dash-main'>
            ...
            <div className='dash-tab'><p className='dash-tab-p'>Total Sales</p><h1 className='dash-tab-head'>323.3k</h1></div>
            <div className='dash-tab'><p className='dash-tab-p'>Last Month Sales</p><h1 className='dash-tab-head'>12.23k</h1></div>
            <div className='dash-tab'><p className='dash-tab-p'>Last Month Performance</p><h1 className='dash-tab-head'>+5.6%</h1></div>
        </div>
    )
}
